...
const planets = [
  { name: 'Mercury', image: require('./assets/mercury.png'), description: 'Mercury is the smallest planet.' },
  { name: 'Venus', image: require('./assets/venus.png'), description: 'Venus is the hottest planet.' },
  { name: 'Earth', image: require('./assets/earth.png'), description: 'Earth is our home planet.' },
  { name: 'Mars', image: require('./assets/mars.png'), description: 'Mars is known as the Red Planet.' },
  { name: 'Jupiter', image: require('./assets/jupiter.png'), description: 'Jupiter is the largest planet.' },
  { name: 'Saturn', image: require('./assets/saturn.png'), description: 'Saturn has beautiful rings.' },
  { name: 'Uranus', image: require('./assets/uranus.png'), description: 'Uranus rotates on its side.' },
  { name: 'Neptune', image: require('./assets/neptune.png'), description: 'Neptune is the farthest planet.' },
];

const quizData = [
  { question: 'Which planet is known as the Red Planet?', options: ['Venus', 'Mars', 'Jupiter', 'Saturn'], answer: 'Mars' },
  { question: 'Which planet has rings?', options: ['Earth', 'Mars', 'Saturn', 'Neptune'], answer: 'Saturn' },
  { question: 'Which is the smallest planet?', options: ['Mercury', 'Venus', 'Earth', 'Mars'], answer: 'Mercury' },
];
...
export default function App() {
  ...
  const handleOptionPress = (option) => {
    ...
    if (quizIndex + 1 < quizData.length) {
      ...
      alert(`Quiz Completed! Your score: ${score + (option === quizData[quizIndex].answer ? 1 : 0)}`);
      setShowQuiz(false);
      setQuizIndex(0);
      setScore(0);
    }
    ...
    return (
      <View style={styles.quizContainer}>
        ...
        {current.options.map((opt, idx) => (
          <TouchableOpacity key={idx} style={styles.optionBtn} onPress={() => handleOptionPress(opt)}>
            <Text>{opt}</Text>
          </TouchableOpacity>
        ))}
      </View>
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>Welcome to Day and Night Space Foundation</Text>
      ...
      {planets.map((planet, index) => (
        <View key={index} style={styles.planetBox}>
